...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Kc(e,t,n){let r=new Float32Array(Mc),i=new K(0,1,0);return new Wo({name:`SphericalGaussianBlur`,defines:{n:Mc,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Yc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function qc(){return new Wo({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Yc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Jc(){return new Wo({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Yc(),fragmentShader:`
	...
	`}var Xc=class extends Kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new aa(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var xu={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Su(e,t){let n=xu[t];return n===void 0?(B(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Cu=new K;function wu(){return J.getLuminanceCoefficients(Cu),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Cu.x.toFixed(4)}, ${Cu.y.toFixed(4)}, ${Cu.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
